...
class Raw_Data_Validation_Training:
    """
    ...
    def __init__(self, raw_data_path, schema_path, logger, log_file_path):
        try:
            ...
            self.log.info('Entered into class >>>>>> Raw_Data_Validation')
    ...
    def checking_schema(self, schema_dtypes, schema_columns):
        ...
        G_path = os.path.join('Training_Batch_Files/Good_Data/')
        B_path = os.path.join('Training_Batch_Files/Bad_Data/')
        ...
        try:
            ...
            self.log.info('Exiting from class <<<<<< Raw_Data_Validation')
            return G_path
